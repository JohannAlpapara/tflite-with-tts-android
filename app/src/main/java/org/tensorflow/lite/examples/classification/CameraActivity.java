...
//    tts = new TextToSpeech(this, this);
  ...
  protected void showResultsInBottomSheet(List<Recognition> results) {
    if (results != null && results.size() >= 3) {
      ...
      if (recognitionValueTextView.getText().toString().equals("100.00%")) {
        if (recognitionTextView.getText().toString().equals("Neutral")) {

        }else {
          tts.speak(recognitionTextView.getText().toString(), TextToSpeech.QUEUE_FLUSH, null);
          addToSentence(recognitionTextView.getText().toString());
        }
      }
